...
$account     = 'youratlassianjira' # Atlassian subdomain i.e. youratlassianjira.atlassian.net (do not enter the ".atlassian.net part", it's already added by the script)
